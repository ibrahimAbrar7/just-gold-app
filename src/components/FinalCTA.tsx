  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-gradient-to-r from-gold-300/30 via-gold-400/20 to-silver-300/30"
      />

      {/* Radial Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-tr from-gold-400/10 to-silver-300/10 rounded-full blur-3xl" />
      ...
      <div className="relative container mx-auto px-6 lg:px-12 text-center">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-navy-900 mb-6 leading-tight">
            Begin Your
            <br />
            <span className="text-gradient-gold-silver">
              Gold & Silver Legacy Today
            </span>
          </h2>

          <p className="text-lg md:text-xl text-navy-500 max-w-2xl mx-auto mb-12 leading-relaxed">
            Join thousands of investors who trust JustGold for their gold and
            silver savings. Open your account in minutes and start building a
